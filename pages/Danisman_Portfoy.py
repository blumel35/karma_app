...
Portföy Panosu ekranı. "Ekle" ve "Kendi Kayıtlarım" burada YOK — ana ekrana
(Danisman_Secim.py) ve hamburger menüye taşındı. Gerçek render mantığı
core.danisman_ortak.render_pano_ekrani içinde — Danisman_Talep.py ile
