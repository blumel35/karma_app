...
def _mt_str(v):
    ...
    # float values are not JSON compliant: nan" hatası veriyordu. Sadece
    # sayısal/tarih alanları (_mt_sayi/_mt_tarih) bu kontrolden geçiyordu,
    # metin alanları unutulmuştu — burada hepsi için düzeltildi.
