...
components.html(
    ...
    (function () {
        ...
        head.appendChild(appleTouchIcon);
              ...
              // Telefon bildirimleri (push) için service worker artık burada
        // DEĞİL — ayrı bir origin'deki mini-PWA'da (bkz. core/
        // push_bildirim.py, bildirim_aktivasyon_linki_uret()).
    })(); 
    </script>
    """,
    height=0,
